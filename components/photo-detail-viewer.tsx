        ...
        >
          <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-[1.2rem] border border-stone-700/70 bg-black/70">
            <Image
              ...
              aria-hidden="true"
              fill
              className="pointer-events-none scale-105 object-cover opacity-30 blur-xl transition-transform duration-500 group-hover:scale-110"
            />
            ...
            <Image
              ...
              alt={item.title ?? ""}
              fill
              className="relative z-10 object-contain shadow-[0_18px_40px_rgba(0,0,0,0.35)]"
            />
